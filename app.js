...
app.get('/vishallokhande', function(request, response) {
    ...
    response.write("<h2><center>Hello all, This vishal lokhande, i am running NodeJS project.... <center></h2>" );
    response.end();
...
app.get('/redirect', function(req, res) {
    //Send status 300
        res.redirect('http://vishallokhande.com');
    });
